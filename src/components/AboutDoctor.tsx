      ...
      <div className="relative z-10 container-custom px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end order-2 lg:order-1">
            <div className="relative bg-card p-6 shadow-md rounded-2xl border border-border flex items-center justify-center">
              <div className="w-64 h-64 aspect-square overflow-hidden rounded-full shadow-lg bg-white flex items-center justify-center">
                <img
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div className="staggered-fade-in space-y-5">
              <span className="inline-flex items-center gap-2 bg-secondary px-4 py-2 rounded-full text-sm font-semibold text-secondary-foreground">
                <Clock size={16} />
              ...
              <div className="space-y-4">
                <div className="bg-background rounded-2xl p-6 shadow border border-border hover:shadow-md transition card-hover">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-cinza-texto">
                        Medicina pela UFRJ, especialização em Endocrinologia, formação em Medicina Integrativa pela Harvard Medical School.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-background rounded-2xl p-6 shadow border border-border hover:shadow-md transition card-hover">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-cinza-texto">
                        Medicina Funcional, Nutrigenômica e tratamentos inovadores para diabetes e saúde hormonal feminina.
                      </p>
                    </div>
                  </div>
                </div>
              </div>
              <blockquote className="relative bg-muted/10 rounded-2xl p-6 border-l-4 border-primary">
