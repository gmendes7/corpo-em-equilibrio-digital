...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden pt-28 pb-16 bg-gradient-to-b from-brand-green-light/50 to-white">
      {/* Decorative leaves */}
      ...
      <div className="absolute top-1/3 left-1/4 w-24 h-24 opacity-15 leaf-animation" style={{ animationDelay: '3s' }}>
        <img src="/leaf1.png" alt="" className="w-full" />
      </div>
      
      <div className="absolute bottom-1/3 right-1/4 w-16 h-16 opacity-15 leaf-animation" style={{ animationDelay: '4s' }}>
        <img src="/leaf2.png" alt="" className="w-full" />
      </div>
      ...
      <div className="container-custom px-6 md:px-12 flex flex-col lg:flex-row items-center">
        ...
        <div className={`w-full lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0 ${isLoaded ? 'staggered-fade-in' : 'opacity-0'}`}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-gray-800 leading-tight">
            ...
            <span className="text-brand-green">sua saúde em primeiro lugar</span>
          </h2>
        ...
        <div className={`w-full lg:w-1/2 flex justify-center ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.5s' }}>
          <div className="relative">
            <div className="absolute -top-12 -left-12 w-40 h-40 bg-brand-green-light rounded-full opacity-60"></div>
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-brand-green rounded-full opacity-20"></div>
            <img 
              src="/doctor.png" 
      ...
      <div className="container-custom px-6 md:px-12 mt-16 lg:mt-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 staggered-fade-in">
          <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-brand-green">
