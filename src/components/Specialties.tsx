...
const specialties = [
  {
    id: 'diabetes',
    title: 'Diabetes',
    icon: <Pill className="w-12 h-12 text-verde-musgo" />,
  ...
  },
  {
    id: 'emagrecimento',
    title: 'Emagrecimento',
    icon: <Weight className="w-12 h-12 text-verde-musgo" />,
  ...
  },
  {
    id: 'menopausa',
    title: 'Menopausa',
    icon: <Egg className="w-12 h-12 text-verde-musgo" />,
  ...
  },
  {
    id: 'genetica',
    title: 'Genética',
    icon: <Dna className="w-12 h-12 text-verde-musgo" />,
...
const Specialties = () => {
  ...
  return (
    <section id="specialties" className="section bg-verde-claro/30">
      <div className="container-custom">
        <div className="text-center mb-12 staggered-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 font-playfair">
            Nossas <span className="text-verde-musgo">Especialidades</span>
          </h2>
            ...
            <button
              ...
              className={`px-5 py-3 rounded-full font-medium transition-all ${
                activeTab === specialty.id
                  ...
                  : 'bg-white text-gray-700 hover:bg-verde-claro'
              }`}
          ...
          {specialties.map((specialty) => (
            ...
            >
              <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-1/3 bg-verde-claro/30 p-8 flex flex-col justify-center items-center text-center">
                ...
                <div className="w-full md:w-2/3 p-8">
                  <p className="text-gray-700 mb-6 text-lg font-lato">
                    {specialty.description}
                  </p>

                  <h4 className="font-semibold text-lg mb-3 text-verde-musgo font-playfair">
                    Benefícios:
                  </h4>
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 font-lato">
                    {specialty.benefits.map((benefit, index) => (
                      ...
                      >
                        <div className="mt-1 min-w-[20px]">
                          <div className="h-5 w-5 rounded-full bg-verde-claro flex items-center justify-center">
                            <div className="h-2 w-2 rounded-full bg-verde-musgo"></div>
                          </div>
                        </div>
                        <span>{benefit}</span>
                      </li>
