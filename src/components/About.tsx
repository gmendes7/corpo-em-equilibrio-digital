        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-2/5 mb-8 lg:mb-0">
            <div className="relative">
              <div className="absolute inset-0 bg-brandGreen-DEFAULT/10 rounded-xl -rotate-3 transform-gpu"></div>
              <img 
              ...
              />
              <div className="absolute top-6 -right-6 bg-brandGreen-light w-24 h-24 rounded-full animate-float"></div>
              <div className="absolute -bottom-6 -left-6 bg-brandGreen-DEFAULT/20 w-16 h-16 rounded-full animate-float" style={{ animationDelay: '1.5s' }}></div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-3/5">
            <div className="staggered-fade-in">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">
                Sobre a <span className="text-brandGreen-DEFAULT">Dra. Patrícia Pólvora</span>
              </h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="bg-brandGreen-light/40 rounded-lg p-4">
              ...
              <blockquote className="border-l-4 border-brandGreen-DEFAULT pl-4 italic text-gray-700 mb-8">
              ...
              <a 
                ...
                className="flex items-center gap-2 text-brandGreen-DEFAULT hover:text-brandGreen-dark transition-colors"
              >
                <Instagram size={22} />
