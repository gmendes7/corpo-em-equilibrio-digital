...
const Contact = () => {
  return (
    <section id="contact" className="section bg-brandGreen-light/20">
      <div className="container-custom">
        <div className="text-center mb-12 staggered-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
            Entre em <span className="text-brandGreen-DEFAULT">Contato</span>
          </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-10 staggered-fade-in">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={4}
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-brandGreen-DEFAULT focus:border-transparent outline-none transition-all resize-none"
                  required
                ></textarea>
              </div>
              <div>
          ...
          <div className="w-full lg:w-5/12 flex flex-col justify-between">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden h-64 mb-6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3675.356305990398!2d-43.18051708503453!3d-22.90442908501379!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x997f5fd24e0bef%3A0x33196351edce2bd2!2sCentro%2C%20Rio%20de%20Janeiro%20-%20RJ!5e0!3m2!1spt-BR!2sbr!4v1653499259046!5m2!1spt-BR!2sbr"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-brandGreen-light rounded-full flex items-center justify-center mb-4">
                  <Mail className="text-brandGreen-DEFAULT" size={24} />
                </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-brandGreen-light rounded-full flex items-center justify-center mb-4">
                  <MapPin className="text-brandGreen-DEFAULT" size={24} />
                </div>
                <h4 className="font-semibold mb-1 text-gray-800">Endereço</h4>
                <p className="text-gray-600">Centro, Rio de Janeiro - RJ</p>
              </div>
              
              <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-brandGreen-light rounded-full flex items-center justify-center mb-4">
                  <Instagram className="text-brandGreen-DEFAULT" size={24} />
                </div>
